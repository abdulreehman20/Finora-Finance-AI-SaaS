    ...
    return (
        ...
        >
            ...
            >
                {/* Icon */}
                <div
                    className={`mb-5 flex items-center justify-center rounded-xl bg-white/5 border border-white/10 group-hover:border-white/20 transition-all duration-300 ${isLarge ? "w-16 h-16" : "w-12 h-12"
                        }`}
                >
                    <Icon
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    A complete suite of intelligent tools to track, analyze, and
